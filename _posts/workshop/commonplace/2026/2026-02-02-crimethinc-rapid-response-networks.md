...
"Each chunk of the city (Southside, Uptown, Whittier, and so on) has rotating shifts of **dispatchers**, who admin a running [Signal](https://signal.org/) call throughout operational hours. Sometimes, multiple dispatchers overlap to split up the extra tasks of watching the chat, relaying reports to other channels, and checking license plates"
